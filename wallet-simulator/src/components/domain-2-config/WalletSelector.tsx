...
export function WalletSelector() {
  ...
  const setWalletSelectionMode = useStore((state) => state.setWalletSelectionMode);
  const setSingleWallet = useStore((state) => state.setSingleWallet);
  const toggleWallet = useStore((state) => state.toggleWallet);

  const { walletFarmInfo } = systemSetup;
  ...
  return (
    <div className="space-y-4">
      <h3 className="font-semibold">Wallet Selection</h3>
