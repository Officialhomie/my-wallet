...
export type ArchetypeName = 'whale' | 'trader' | 'casual' | 'lurker' | 'researcher' | 'flexible';
...
export interface ArchetypeInfo {
  ...
  detailedDescription?: string; // Full explanation including skip behavior
  activeRate?: string; // Percentage of interactions actually executed (e.g., "85%")
  characteristics?: string[]; // Key behavioral traits
  warning?: string; // Optional warning for archetypes with very low activity
  icon: string;
}
